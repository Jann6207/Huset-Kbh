...
function post184Output(){
      ...
      //indsæt header info
            ...
            //Billede url
            document.querySelector("img").src = post184.acf.billede.url;
            //alt tekst url
            document.querySelector("img").alt = post184.acf.billede.alt;
            //title
            document.querySelector("img").title = post184.acf.billede.title;
