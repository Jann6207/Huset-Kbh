    document.addEventListener("DOMContentLoaded", getJson);
        ...
        async function getJson() {
            ...
            let jsonObject = await fetch("http://jakobfalkenberg.dk/kea/2sem/tema7/huset/wordpress/wp-json/wp/v2/bip_bip_bar/184");
            ...
            document.querySelector(".bib_bib_bar_content").innerHTML = page.content.rendered;
