    document.addEventListener("DOMContentLoaded", getJson);
        ...
        async function getJson() {
            ...
            let jsonObject = await fetch("http://jakobfalkenberg.dk/kea/2sem/tema7/huset/wordpress/wp-json/wp/v2/privat_arrangements/179");
            ...
            document.querySelector(".privat_arrangement_content").innerHTML = page.content.rendered;
