...
function post191Output (){
        ...
        //indsæt header info
            ...
            //Billede url
            document.querySelector("img").src = post191.acf.billede.url;
            //alt tekst url
            document.querySelector("img").alt = post191.acf.billede.alt;
            //title
            document.querySelector("img").title = post191.acf.billede.title;
