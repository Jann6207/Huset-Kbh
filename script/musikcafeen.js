    document.addEventListener("DOMContentLoaded", getJson);
        ...
        async function getJson() {
            ...
            let jsonObject = await fetch("http://jakobfalkenberg.dk/kea/2sem/tema7/huset/wordpress/wp-json/wp/v2/musikcafe/187");
            ...
            document.querySelector(".musickafeen_wrapper_content").innerHTML = page.content.rendered;
