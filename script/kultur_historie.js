    document.addEventListener("DOMContentLoaded", getJson);
        ...
        async function getJson() {
            ...
            let jsonObject = await fetch("http://jakobfalkenberg.dk/kea/2sem/tema7/huset/wordpress/wp-json/wp/v2/kultur_historie/196");
            ...
            document.querySelector(".kultur_historie_content").innerHTML = page.content.rendered;
