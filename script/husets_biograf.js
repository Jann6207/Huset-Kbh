    document.addEventListener("DOMContentLoaded", getJson);
        ...
        async function getJson() {
            ...
            let jsonObject = await fetch("http://jakobfalkenberg.dk/kea/2sem/tema7/huset/wordpress/wp-json/wp/v2/husets_biograf/113");
            ...
            document.querySelector(".husets_biograf_content").innerHTML = page.content.rendered;
